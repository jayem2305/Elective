            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item"><a class="nav-link " href="#about">Company’s Profile</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.php#exampleModal">Reservation</a></li>
                    <li class="nav-item"><a class="nav-link text-decoration-underline"  href="reservations_list.php" >Reserved information</a></li>
                                  ...
                                  <?php foreach ($reservations as $reservation): ?>
                                    <tr>
                                        ...
                                        <td><div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                          ...
                                          <form method="post" action="index.php?action=deleteReservation">
...
<?php foreach ($reservations as $reservation): ?>
    <div class="modal fade" id="exampleModal<?php echo $reservation['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        ...
        <form method="post" action="index.php?action=updateReservation">
             <?php
